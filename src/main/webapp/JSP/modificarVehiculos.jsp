                ...
                <table class="table-auto bg-custom-gray w-full text-left border-collapse">
                    ...
                    <form action="modificarVehiculoController" method="post">
                        ...
                        <button type="submit"  name="boton" value="modificar" 
                                class="flex flex-col items-center justify-center  bg-green-700 hover:bg-green-600 text-shadow-black font-bold py-2 px-4 rounded focus:outline-none m-4">Modificar</button>
                    </form>

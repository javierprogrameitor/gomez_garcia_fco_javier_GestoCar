...
<html lang="es">
    ...
    <body class="bg-custom-green font-bobby-jones h-auto">
        ...
        <div class="flex flex-col items-center justify-center p-4 mt-18 mb-10">
            <div class="verflow-x-auto w-full max-w-7xl">
                ...
                <c:if test="${not empty mensaje}">
                    <div class="bg-green-200 border-l-4 border-green-500 text-green-700 p-4" role="alert">
                        <p class="flex items-center justify-center font-bold">Mensaje:</p>
                        <p class="flex items-center justify-center font-bold">${mensaje}</p>
                    </div>
                </c:if>
                ...
                <form action="administradorController" method="post">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" name="boton" value="eliminarUsuario" class="flex items-center justify-center bg-green-700 hover:bg-green-600 text-shadow-black font-bold py-2 px-4 rounded focus:outline-none m-4">
                            ELIMINAR USUARIO
                        </button>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <button type="submit" name="boton" value="eliminarVehiculo" class="flex items-center justify-center bg-green-700 hover:bg-green-600 text-shadow-black font-bold py-2 px-4 rounded focus:outline-none m-4">
                            ELIMINAR VEHÍCULO
                        </button>
                    </div>
                </form>

...
<html lang="es">
    ...
    <body class="bg-custom-green font-bobby-jones h-full">
        ...
        <div class="flex justify-center p-4 mt-18 mb-10">
            <div class="overflow-x-auto w-full max-w-7xl">              
                <h1 class="flex items-center justify-center text-shadow-black text-green-700 text-3xl font-black">Listado de tus Veh&iacute;culos</h1>
